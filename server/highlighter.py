...
class Highlighter:
    ...
    def __init__(self, fname, model=None, category=4, _skip_rate=4, _max_array_ratio=0.27, _min_scene_length = 6, _max_scene_length=30, _alpha = 0.05):
        self.cap = cv2.VideoCapture(fname)
        self.length = int(self.cap.get(CV_CAP_PROP_FRAME_COUNT))
        self.lock = Lock()
        ...
        self.fps = self.cap.get(CV_CAP_PROP_FPS)
